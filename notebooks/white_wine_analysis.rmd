...
```{r ggpairs-plot, echo=FALSE, message=FALSE,fig.cap="Correlation plot of the predictor variables"}
...
variable listed in Figure \@ref(fig:count-plot) was visualitzed to evaluate the utility for
